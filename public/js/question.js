...
$(function () {
  ...
  function displayCorrectAnswerAndReload() {
    ...
    incrementScore();
    axios.post('/check-win').then(function (response) {
      if (response.data) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire('Resposta Correta!', '', 'success').then(function () {
          window.location.href = '/success';
        });
      } else {
        sweetalert2__WEBPACK_IMPORTED_MODULE_0___default.a.fire('Resposta Correta!', '', 'success');
        reloadAnswer();
      }
    });
  }
  ...
  function watchAnswerButton() {
    $('.check-answer').click(function (event) {
      ...
      showLoader();
      axios.post(this.href).then(function (response) {
        hideLoader();
        if (response.data) displayCorrectAnswerAndReload();else displayIncorrectAnswerAndReload();
